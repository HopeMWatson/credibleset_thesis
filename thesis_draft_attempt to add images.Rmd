...
Association p-values converted to Bayesian posterior probabilities of causality under specific assumptions [@Stephens2009] [@Wakefield2007].  These can be summed over sets of variants to generate a posterior probability a causal variant lies in any given set. The posterior probabilities are the ratio of evidence for each variant beign causal versus all the others. This is expressed as 
\begin{equation}
