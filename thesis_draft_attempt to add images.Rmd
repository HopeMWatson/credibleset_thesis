...
Each dot on a Manhattan plot represents one haplotype. The x axis is the loci, which is the position of the SNP on the chromosome. On the y axis is the -log p value of the association found in the haplotype in the cases compared to the control group. Dots farther up on the y axis represent a haplotype that has a stronger association with the phenotype. The null hypothesis is that each haplotype has no assocation with the phenotype. Candidate 
